...
namespace parameters {
  ...
  const uint64_t MONEY_SUPPLY                                  = (uint64_t)(1000000); //-1
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "lab-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "lab-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "lab-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "lab-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "lab-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "lab-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "lab-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "LABcoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101b18e7a0340334239af5479991238e4ee9d545f376bf1cccd21ee1b9";
...
const int      P2P_DEFAULT_PORT                              = 20050;
const int      RPC_DEFAULT_PORT                              = 19050;
